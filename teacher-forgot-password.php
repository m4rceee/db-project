        ...
        if(!empty($_POST['email']) && !empty($_POST['newPass'])) {
            ...
            if ($mysqli->connect_errno) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    $notfound_err = "<div class='alert alert-danger mt-2'><strong>Incorrect email.</strong></div>";
                }
            }
        } else if(empty($_POST['email']) && !empty($_POST['newPass'])) {
            $email_err = "<div class='alert alert-danger mt-2'><strong>Please enter an e-mail.<strong></div>";
        } 
        else if(empty($_POST['newPass']) && !empty($_POST['email'])) {
...
<body>
    ...
    <div class="cn-1 container">
        <div class="card mx-auto">
            <div class="card-body">
                <form action="teacher-forgot-password.php" method="POST">
